...
| <a name="input_principal"></a> [principal](#input\_principal) | The principal that will be granted permissions to use the KMS key. This is typically an IAM role or user ARN. | `string` | n/a | yes |
