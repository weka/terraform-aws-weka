...
| <a name="input_clusterize_finalization_lambda_name"></a> [clusterize\_finalization\_lambda\_name](#input\_clusterize\_finalization\_lambda\_name) | The name of the status function | `string` | n/a | yes |
| <a name="input_clusterize_lambda_name"></a> [clusterize\_lambda\_name](#input\_clusterize\_lambda\_name) | The name of the status function | `string` | n/a | yes |
