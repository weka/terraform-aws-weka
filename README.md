...
| <a name="input_weka_cgroups_mode"></a> [weka\_cgroups\_mode](#input\_weka\_cgroups\_mode) | Weka cgroups mode for backend instances. Valid values are 'auto' and 'force\_v2'. Defaults to 'force\_v2'. | `string` | `null` | no |
