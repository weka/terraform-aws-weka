...
| <a name="input_ami_id"></a> [ami\_id](#input\_ami\_id) | AMI ID to use for backend instances. If not specified, automatically selects: Amazon Linux 2 x86\_64 for i3en instances, Amazon Linux 2023 ARM for i8ge instances. | `string` | `null` | no |
...
| <a name="input_clients_weka_cgroups_mode"></a> [clients\_weka\_cgroups\_mode](#input\_clients\_weka\_cgroups\_mode) | Weka cgroups mode for client instances. Valid values are 'auto' and 'force\_v2'. | `string` | `"auto"` | no |
...
| <a name="input_lambdas_version"></a> [lambdas\_version](#input\_lambdas\_version) | Lambdas code version (hash) | `string` | `"af475536ab2d9d694da22c1f2a9e4f94"` | no |
...
| <a name="input_weka_cgroups_mode"></a> [weka\_cgroups\_mode](#input\_weka\_cgroups\_mode) | Weka cgroups mode for backend instances. Valid values are 'auto' and 'force\_v2'. If not specified, defaults to 'auto' for i3en instances and 'force\_v2' for i8ge instances. | `string` | `null` | no |
