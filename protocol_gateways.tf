module "smb_protocol_gateways" {
  ...
  protocol                 = "SMB"
  frontend_cores_num       = var.smb_protocol_gateway_fe_cores_num
  ...
  frontend_container_num   = var.smb_protocol_gateway_frontend_container_num
...
module "nfs_protocol_gateways" {
  ...
  protocol                 = "NFS"
  frontend_cores_num       = var.nfs_protocol_gateway_fe_cores_num
  ...
  frontend_container_num   = var.nfs_protocol_gateway_frontend_container_num
  install_weka_url         = local.install_weka_url
  weka_token_id            = aws_secretsmanager_secret.get_weka_io_token.id
  weka_password_id         = aws_secretsmanager_secret.weka_password.id
  proxy_url                = var.proxy_url
